...
const MenuBtn: React.FC<MenuBtnProps> = (props: MenuBtnProps) => {
    ...
    if (props?.back)
        classes.push("no-hide")

    return <svg onClick={props.back ? () => navigate(-1) : () => showMenu()} className={classes.join(" ")} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
